...
void statusloop();
void termhandler(int signum);  // Изменено: добавлен параметр int
void pstdout();
#ifndef NO_X
void setroot();
...
// Добавьте эти extern объявления для переменных из blocks.h
//extern char delim[];
//extern int delimLen;
...
// static int returnStatus = 0;  // Закомментировано: переменная не используется
